...
thk_nav_stick();var R=false;w.addEventListener("resize",function(){if(R===false){requestAnimationFrame(function(){R=false;e.style.width="";offsetCalc();});R=true;}},false);function thk_pin(o,sp,trs,cls){var s=o.style;if(typeof trs==="undefined")var trs="all .5s ease-in-out";if(typeof cls==="undefined")var cls="pin";s.transition=trs,s.top=sp+"px",s.position="fixed",s.width=o.clientWidth+'px'
